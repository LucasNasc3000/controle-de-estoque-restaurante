...
var _inputSearchByEntryDate = require('./routes/input/inputSearchByEntryDate'); var _inputSearchByEntryDate2 = _interopRequireDefault(_inputSearchByEntryDate);
...
var _outputSearchByWeight = require('./routes/output/outputSearchByWeight'); var _outputSearchByWeight2 = _interopRequireDefault(_outputSearchByWeight);
...
class App {
  ...
  routes() {
    ...
    this.app.use('/inputs/search/entrydate/', _inputSearchByEntryDate2.default);
    ...
    this.app.use('/outputs/search/weight/', _outputSearchByWeight2.default);
