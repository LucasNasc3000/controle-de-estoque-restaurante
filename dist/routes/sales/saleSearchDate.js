...
router.get('/:date', _loginRequired2.default, _salesPermission2.default, _SalesSearchSalesData2.default.SearchByDate);
router.post('/', _loginRequired2.default, _salesPermission2.default, _SalesSearchSalesData2.default.SearchByDateDashboard);
